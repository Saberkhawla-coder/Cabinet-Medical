...
function RdvTable() {
  ...
  const CurrentRdv=appointments.slice(indexFirst, indexLast)
              ...
              CurrentRdv.map((appoint) => (
                ...
                >
                  ...
                  <td className="py-5 px-6 flex space-x-3">
                    <button  type="button"  className="p-2 text-blue-600 hover:bg-blue-100 rounded-lg">
                      <Eye size={18} />
                    </button>
