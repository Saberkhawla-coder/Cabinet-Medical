  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md relative animate-fadeIn">
        <h2 className="text-2xl font-bold mb-6 text-gray-900 text-center">Modifier RDV</h2>
        <form className="flex flex-col  gap-4" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="mt-4 bg-blue-600 text-white p-3 rounded-lg hover:scale-105 transition-all">Enregistrer</button>
        </form>
