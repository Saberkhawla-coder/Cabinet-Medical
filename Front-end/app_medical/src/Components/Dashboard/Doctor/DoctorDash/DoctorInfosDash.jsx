      ...
      <div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          ...
          <InfoCard
              ...
              <InfoCard
              icon={<UsersRound />}
              label="Patients cette année"
              value={yearPatients?.length || 0}
              />
          <InfoCard valueClassName={doctor?.is_active ? "text-green-600" : "text-red-600"} icon={<FaUserDoctor />} label={doctor?.user?.name} value={doctor?.is_active ? "Actif" : "Inactif"} />
